...
Status varchar(250));
go 
insert into Customer(Customer_ID, Name, Address, tel, Status) Values (12,'NgocHieu', 'trancung, co nhue,HN', 03232323, 'shipping');
insert into Customer(Customer_ID, Name, Address, tel, Status) Values (13,'tranluc', 'my dinh, NTL,HN', 032365656, 'shipping');
insert into Customer(Customer_ID, Name, Address, tel, Status) Values (14,'dangcongthanh', 'Hoang Quoc Viet,Cau Giay,HN', 0323256565, 'shipping');
insert into Customer(Customer_ID, Name, Address, tel, Status) Values (15,'huyhoang', 'trancung, co nhue,HN', 0323545454, 'shipping');
insert into Customer(Customer_ID, Name, Address, tel, Status) Values (16,'phannghia', 'trancung, co nhue,HN', 0323298989, 'shipping');
